...
module.exports = function (sequelize, DataTypes) {
    ...
    Products.associate = function (models) {
        ...
        Products.hasMany(models.dealsproducts, {
            foreignKey: {
                name: "productId",
                notEmpty: false
            },
        ...
        Products.belongsTo(models.vendordetails, {
            foreignKey: {
    ...
    Products.afterCreate(function(ins, opt) {
        var auditTrailData = {
    ...
    Products.beforeUpdate(function(ins, opt) {
     ...
     Products.afterDestroy(function(ins, opt) {
         var auditTrailData = {
                modelName: ins['$modelOptions'].name.singular,
                tableName: ins['$modelOptions'].name.plural,
                pastData: JSON.stringify(ins._previousDataValues),
